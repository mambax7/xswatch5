<ul class="nav flex-column">
    <li class="nav-item">
        <a class="nav-link<{if !$block.nothome|default:false}> active<{/if}>" href="<{xoAppUrl }>" title="<{$block.lang_home}>"><span class="fa fa-home fa-fw"></span> <{$block.lang_home}></a>
    </li>
    ...
    <{foreach item=module from=$block.modules}>
        <li class="nav-item <{if $module.highlight|default:false}>bg-secondary rounded pb-0<{/if}>">
            <a class="nav-link<{if $module.highlight|default:false}> active<{/if}>" href="<{$xoops_url}>/modules/<{$module.directory}>/" title="<{$module.name}>">
                <span class="fa <{if $module.highlight|default:false}>fa-check-square-o<{else}>fa-square-o text-light<{/if}> fa-fw "></span> <{$module.name}>
            </a>
