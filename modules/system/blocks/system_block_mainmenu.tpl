<ul class="nav flex-column">
    <li class="nav-item">
        <a class="nav-link<{if !$block.nothome|default:false}> active<{/if}>" href="<{xoAppUrl }>" title="<{$block.lang_home}>"><span class="fa fa-home text-info fa-fw"></span> <{$block.lang_home}></a>
    </li>
