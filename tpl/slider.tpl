<{if $xoops_page == "index"}>
	<!-- Add "vertical" in the class below for a vertical scroll -->
	<div id="sliderCarousel" class="carousel slide mb-4" data-bs-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="<{$xoops_imageurl}>images/slides/1-DSCN1071.jpeg" class="d-block w-100" alt="First slide">
			...
			<div class="carousel-item">
				<img src="<{$xoops_imageurl}>images/slides/2-DSCN0919.jpeg" class="d-block w-100" alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h2 class="slidetext"><{$xoops_sitename}></h2>
					<p class="slidetext"><{$xoops_slogan}></p>
			...
			<div class="carousel-item">
				<img src="<{$xoops_imageurl}>images/slides/3-DSCN0875.jpeg" class="d-block w-100" alt="Third slide">
				<div class="carousel-caption d-none d-md-block">
